...
export default function Footer() {
	return (
		<footer className="relative overflow-hidden bg-gray-900 text-white">
			<div
				aria-hidden
				className="pointer-events-none absolute -top-24 -left-20 h-56 w-56 rounded-full bg-blue8/15 blur-2xl"
			/>
			<div
				aria-hidden
				className="pointer-events-none absolute -bottom-20 right-0 h-64 w-64 rounded-full bg-blue6/15 blur-2xl"
			/>
			<div
				aria-hidden
				className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-blue10/70 to-transparent"
			/>
					...
					<div className="lg:col-span-2">
						<div className="mb-6">
							...
							<p className="text-gray-300 text-sm leading-relaxed max-w-md">
								Especialistas en integración y automatización de procesos
								críticos. Creamos soluciones tecnológicas que optimizan tu
								operación y conectan con tus clientes.
							</p>
						</div>
