			...
			<div className="space-y-4">
				{sortedSteps.map((step, index) => (
					<div key={step.id}>
						{/* Step Card */}
						<div
							className={`relative border-2 rounded-xl p-4 transition-all duration-200 ${getStepColor(step.status)}`}
						>
								...
								<div className="flex-1 min-w-0">
									<div className="flex items-start justify-between">
										<div className="flex-1">
											<h4
												className={`font-semibold text-lg ${getStepTextColor(step.status)}`}
											>
												{step.name}
											</h4>
