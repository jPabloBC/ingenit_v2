...
interface ProcessTemplate {
	...
	steps: Omit<
		ProcessStep,
		"id" | "status" | "actual_hours" | "notes" | "completed_at" | "assigned_to"
	>[];
}
...
export default function ProcessTrackingPage() {
	...
	const [_selectedProcess, _setSelectedProcess] = useState<Process | null>(
		null,
	);
	...
	const processTemplates: ProcessTemplate[] = [
		{
			...
			description:
				"Proceso completo de implementación de chatbot de WhatsApp con menús interactivos",
			steps: [
				{
					name: "Análisis de Requerimientos del Cliente",
					description:
						"Entrevistar al cliente para entender necesidades específicas del chatbot",
					order: 1,
					estimated_hours: 4,
				},
				{
					name: "Diseño de Arquitectura del Bot",
					description:
						"Diseñar la estructura de conversación y flujos de navegación",
					order: 2,
					estimated_hours: 8,
				},
				{
					name: "Creación de Menús Interactivos",
					description: "Desarrollar menús con botones y opciones de navegación",
					order: 3,
					estimated_hours: 12,
				},
				{
					name: "Configuración de Respuestas Automáticas",
					description:
						"Programar respuestas automáticas para preguntas frecuentes",
					order: 4,
					estimated_hours: 16,
				},
				{
					...
					description:
						"Conectar con sistemas CRM, bases de datos y servicios web",
					order: 5,
					estimated_hours: 20,
				},
				{
					...
					description:
						"Desarrollar lógica para cotizaciones, citas y consultas",
					order: 6,
					estimated_hours: 24,
				},
				{
					name: "Testing y Depuración",
					description: "Probar todos los flujos y corregir errores",
					order: 7,
					estimated_hours: 16,
				},
				{
					name: "Configuración de Webhooks",
					description:
						"Configurar webhooks para integración con WhatsApp Business API",
					order: 8,
					estimated_hours: 8,
				},
				{
					name: "Entrenamiento del Equipo",
					description: "Capacitar al equipo en el uso y mantenimiento del bot",
					order: 9,
					estimated_hours: 6,
				},
				{
					name: "Despliegue y Activación",
					description:
						"Activar el bot en producción y monitorear funcionamiento",
					order: 10,
					estimated_hours: 4,
				},
				{
					name: "Documentación y Manuales",
					description: "Crear documentación técnica y manuales de usuario",
					order: 11,
					estimated_hours: 8,
				},
				{
					name: "Seguimiento y Optimización",
					description: "Monitorear métricas y optimizar rendimiento",
					order: 12,
					estimated_hours: 12,
				},
			],
			...
			steps: [
				{
					...
					description: "Recopilar y analizar requerimientos del cliente",
					order: 1,
					estimated_hours: 8,
				},
				{
					name: "Diseño de Arquitectura",
					description: "Diseñar la arquitectura técnica del sistema",
					order: 2,
					estimated_hours: 16,
				},
				{
				...
				},
				{
					...
					description: "Implementar la lógica del servidor",
					order: 4,
					estimated_hours: 32,
				},
				{
					name: "Integración",
					description: "Integrar frontend y backend",
					order: 5,
					estimated_hours: 16,
				},
				{
					name: "Testing",
					description: "Pruebas de funcionalidad y calidad",
					order: 6,
					estimated_hours: 24,
				},
				{
				...
				{
					name: "Documentación",
					description: "Documentar el sistema",
					order: 8,
					estimated_hours: 12,
				},
			],
		},
		{
			...
			description:
				"Proceso de instalación y configuración de infraestructura de red",
			steps: [
				{
					name: "Evaluación del Sitio",
					description: "Evaluar las necesidades de red del sitio",
					order: 1,
					estimated_hours: 4,
				},
				{
					name: "Diseño de Red",
					description: "Diseñar la topología de red",
					order: 2,
					estimated_hours: 8,
				},
				{
					name: "Instalación de Cableado",
					description: "Instalar cableado estructurado",
					order: 3,
					estimated_hours: 24,
				},
				{
					name: "Configuración de Switches",
					description: "Configurar switches y routers",
					order: 4,
					estimated_hours: 16,
				},
				{
					name: "Configuración WiFi",
					description: "Configurar puntos de acceso WiFi",
					order: 5,
					estimated_hours: 12,
				},
				{
					name: "Configuración de Seguridad",
					description: "Implementar medidas de seguridad",
					order: 6,
					estimated_hours: 16,
				},
				{
					name: "Pruebas de Conectividad",
					description: "Verificar conectividad y rendimiento",
					order: 7,
					estimated_hours: 8,
				},
				{
					name: "Entrega y Capacitación",
					description: "Entregar sistema y capacitar usuarios",
					order: 8,
					estimated_hours: 8,
				},
			],
			...
			steps: [
				{
					...
					description: "Evaluar el estado actual del sistema",
					order: 1,
					estimated_hours: 16,
				},
				{
					name: "Análisis de Procesos",
					description: "Analizar procesos actuales",
					order: 2,
					estimated_hours: 24,
				},
				{
					name: "Identificación de Oportunidades",
					description: "Identificar oportunidades de mejora",
					order: 3,
					estimated_hours: 20,
				},
				{
					name: "Propuesta de Soluciones",
					description: "Desarrollar propuestas de mejora",
					order: 4,
					estimated_hours: 32,
				},
				{
					name: "Presentación al Cliente",
					description: "Presentar recomendaciones",
					order: 5,
					estimated_hours: 8,
				},
				{
					name: "Implementación",
					description: "Implementar soluciones aprobadas",
					order: 6,
					estimated_hours: 40,
				},
				{
					name: "Seguimiento",
					description: "Monitorear resultados",
					order: 7,
					estimated_hours: 16,
				},
				{
					name: "Cierre del Proyecto",
					description: "Documentar resultados y cerrar proyecto",
					order: 8,
					estimated_hours: 12,
				},
			],
		...
		try {
			...
			if (error) {
				...
				if (error.code === "PGRST116" || error.message?.includes("404")) {
					console.log(
						"La tabla 'processes' no existe. Ejecuta el script SQL para crearla.",
					);
					setProcesses([]);
				} else {
					// Otros errores
				...
				const transformedProcesses: Process[] = (processesData || []).map(
					(process) => ({
						id: process.id,
						name: process.name,
	...
	const createProcess = async (processData: {
		...
		try {
			const selectedTemplate = processTemplates.find(
				(t) => t.id === processData.template_id,
			);
			if (!selectedTemplate) {
			...
			if (error) {
				...
				if (error.code === "PGRST116" || error.message?.includes("404")) {
					alert(
						"Error: La tabla 'processes' no existe en la base de datos. Por favor, ejecuta el script SQL para crear la tabla.",
					);
				} else {
				...
				<div className="col-span-full">
					<div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
						...
						<p className="text-gray-600 mb-6">
							Comienza creando tu primer proceso de seguimiento para gestionar
							tus proyectos
						</p>
						<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
							<p className="text-sm text-yellow-800">
								<strong>Nota:</strong> Si ves errores 404, es posible que
								necesites crear la tabla 'processes' en Supabase. Ejecuta el
								script SQL{" "}
								<code className="bg-yellow-100 px-1 rounded">
									create-processes-table.sql
								</code>{" "}
								en tu base de datos.
							</p>
						</div>
						...
						>
								...
								<div className="flex items-start justify-between mb-4">
									<div className="flex-1">
										...
										<div className="flex items-center gap-4 text-sm">
											...
											<span
												className={`px-2 py-1 rounded-full text-xs font-medium ${getPriorityColor(process.priority)}`}
											>
											...
											<span className="text-gray-500">
												Asignado a: {process.assigned_to}
											</span>
										</div>
									</div>
									<div className="flex items-center gap-2">
										<button
											...
											onClick={(event) => {
												...
												router.push(`/admin/process-tracking/${process.id}`);
											}}
							...
							<div className="p-6">
								...
								<div className="space-y-3">
									{process.steps.slice(0, 4).map((step, _index) => (
										<div key={step.id} className="flex items-center gap-3">
											...
											<div className="flex items-center gap-1">
												<button
													...
													onClick={(event) => {
														event.stopPropagation();
														updateStepStatus(process.id, step.id, "completed");
													}}
												...
												<button
													...
													onClick={(event) => {
														event.stopPropagation();
														updateStepStatus(process.id, step.id, "error");
													}}
									...
									{process.steps.length > 4 && (
										<div className="text-center pt-2">
											<button
												type="button"
												className="text-blue6 hover:text-blue7 text-sm font-medium"
											>
