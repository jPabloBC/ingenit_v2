...
export default function ProcessDetailPage() {
	...
	const getProcessIcon = (processName: string) => {
		if (processName.toLowerCase().includes("whatsapp"))
			return <MessageCircle className="w-6 h-6" />;
		if (processName.toLowerCase().includes("web"))
			return <Globe className="w-6 h-6" />;
		if (processName.toLowerCase().includes("red"))
					...
					<div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
						...
						{isEditing ? (
							<div className="space-y-4">
								...
								<div>
									<label
										htmlFor="process-assigned-to"
										className="block text-sm font-medium text-gray-700 mb-2"
									>
										Asignado a
									</label>
									<input
										id="process-assigned-to"
										type="text"
							...
							<div className="space-y-4">
								<div className="flex items-center gap-2 text-sm text-gray-600">
									...
									<span>
										Fecha de entrega:{" "}
										{process.due_date
											? new Date(process.due_date).toLocaleDateString("es-CL")
											: "No definida"}
									</span>
								</div>
								<div className="flex items-center gap-2 text-sm text-gray-600">
					...
					<div className="bg-white rounded-2xl max-w-md w-full">
						...
						<div className="p-6">
							<div className="space-y-4">
								...
								<div>
									<label
										htmlFor="new-step-estimated-hours"
										className="block text-sm font-medium text-gray-700 mb-2"
									>
										Horas estimadas
									</label>
									<input
										id="new-step-estimated-hours"
										type="number"
										value={newStep.estimated_hours || ""}
										onChange={(e) =>
											setNewStep((prev) => ({
												...prev,
												estimated_hours: parseInt(e.target.value, 10),
											}))
										}
										className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue6 focus:border-transparent"
										placeholder="8"
								...
								<div>
									<label
										htmlFor="new-step-assigned-to"
										className="block text-sm font-medium text-gray-700 mb-2"
									>
										Asignado a
									</label>
									<input
										id="new-step-assigned-to"
										type="text"
