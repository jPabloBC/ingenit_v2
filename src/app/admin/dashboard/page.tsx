				...
				{isLoading ? (
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
						{["skeleton-1", "skeleton-2", "skeleton-3"].map((key) => (
							<div
								key={key}
								className="bg-gray-50 rounded-md p-4 border border-gray-200 animate-pulse"
							>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
					...
					<div className="group">
						<button
							...
							className="w-full p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 hover:from-indigo-100 hover:to-indigo-200 rounded-md border border-indigo-200 transition-all duration-200 hover:shadow-md hover:scale-105"
						>
							<div className="flex items-center justify-between mb-3">
								<div className="p-2 bg-indigo-600 rounded-md">
									<Store className="w-5 h-5 text-white" />
								</div>
								<Store className="w-4 h-4 text-indigo-600 group-hover:text-indigo-800" />
							</div>
							<h3 className="font-semibold text-gray-900 text-left">
								DS - Catálogo
							</h3>
							<p className="text-xs text-gray-600 text-left mt-1">
								Productos base y asignación por vendedor
							</p>
						</button>
					</div>
