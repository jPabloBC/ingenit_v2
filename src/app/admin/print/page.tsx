"use client";
import { ClipboardList, FileText, Image, Printer } from "lucide-react";
		...
		<main className="relative z-0 min-h-screen bg-white text-gray-900 font-body">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					<a
						href="/admin/print/image"
						className="block bg-yellow-50 border border-yellow-200 rounded-xl p-6 shadow hover:shadow-lg transition no-underline"
					>
					...
					<a
						href="/admin/print/assignments"
						className="block bg-cyan-50 border border-cyan-200 rounded-xl p-6 shadow hover:shadow-lg transition no-underline"
					>
						<div className="flex items-center gap-3">
							<ClipboardList className="w-7 h-7 text-cyan-600" />
							<h2 className="font-semibold text-lg">Asignación de tareas</h2>
						</div>
					</a>
					<a
						href="/admin/print/history"
						className="block bg-blue-50 border border-blue-200 rounded-xl p-6 shadow hover:shadow-lg transition no-underline"
					>
						<div className="flex items-center gap-3">
