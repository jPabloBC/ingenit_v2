						...
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="text-2xl font-bold">
									{leads.length > 0
										? Math.round(
												leads.reduce((sum, l) => sum + l.lead_score, 0) /
													leads.length,
											)
										: 0}
								</p>
							...
							<div className="flex justify-between items-start">
								<div className="flex-1">
									<div className="flex items-center space-x-3 mb-3">
										...
										<div
											className={`flex items-center space-x-1 ${getScoreColor(lead.lead_score)}`}
										>
									...
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
										<div className="flex items-center space-x-2">
											...
											<span className="text-sm text-gray-600">
												{lead.industry || "No especificado"}
											</span>
										</div>
										<div className="flex items-center space-x-2">
											<Target className="h-4 w-4 text-gray-500" />
											<span className="text-sm text-gray-600">
												{lead.solution_type || "No especificado"}
											</span>
										</div>
										<div className="flex items-center space-x-2">
											<Users className="h-4 w-4 text-gray-500" />
											<span className="text-sm text-gray-600">
												{lead.users_count} usuarios
											</span>
										</div>
										<div className="flex items-center space-x-2">
											<Clock className="h-4 w-4 text-gray-500" />
											<span className="text-sm text-gray-600">
												{lead.timeline || "No especificado"}
											</span>
										</div>
									</div>
