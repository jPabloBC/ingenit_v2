				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center max-w-4xl mx-auto">
						...
						<p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
							Completa el formulario para comunicarte con nuestro equipo y
							comenzar tu próximo proyecto tecnológico.
						</p>
							...
							<div className="bg-white p-8 rounded-2xl shadow-xl max-w-md mx-auto border border-gray-100">
								<div className="text-center">
									...
									<p className="text-gray-600">
										Tu mensaje fue enviado correctamente. Nos pondremos en
