        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              Creamos soluciones tecnológicas avanzadas que optimizan tu operación y conectan 
              con tus clientes de manera eficiente y profesional.
            </p>
              ...
              {open && (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 mb-6">Contáctanos</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Nos especializamos en crear soluciones tecnológicas que realmente funcionan para tus proyectos
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Soluciones Personalizadas</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Tecnología Avanzada</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Soporte Continuo</h3>
              <p className="text-gray-600">
