...
export const BANK_CATALOG: BankCatalogItem[] = [
	// Principales bancos (tipos CLP + USD combinados)
	{
		code: "BANCO_CHILE",
		name: "Banco de Chile",
		types: ["checking", "checking_usd", "savings", "credit", "credit_usd"],
		issuesCards: true,
	},
	{
		code: "BANCO_ESTADO",
		...
		issuesCards: true,
		logoUrl:
			"https://juupotamdjqzpxuqdtco.supabase.co/storage/v1/object/public/ingenit/banks/bancoestado.png",
	},
	{
		code: "SANTANDER",
		...
		issuesCards: true,
		logoUrl:
			"https://juupotamdjqzpxuqdtco.supabase.co/storage/v1/object/public/ingenit/banks/banco-santander.png",
	},
	{
		code: "BCI",
		name: "Banco BCI",
	...
	},
	{
		...
		issuesCards: true,
		logoUrl:
			"https://juupotamdjqzpxuqdtco.supabase.co/storage/v1/object/public/ingenit/banks/banco-falabella.png",
	},
	{
		code: "BANCO_RIPLEY",
		name: "Banco Ripley",
	...
	// Casas comerciales y emisores de tarjetas de marca propia (tipos combinados)
	{
		code: "FALABELLA",
		name: "Falabella",
		types: ["credit", "credit_usd", "store_credit"],
		issuesCards: true,
		logoUrl:
			"https://juupotamdjqzpxuqdtco.supabase.co/storage/v1/object/public/ingenit/banks/banco-falabella.png",
	},
	...
	{
		code: "PARIS",
		name: "Almacenes Paris",
		types: ["credit", "credit_usd", "store_credit"],
		issuesCards: true,
	},
	{
		code: "CENCOSUD",
		name: "Cencosud (Jumbo, Santa Isabel, París)",
		types: ["credit"],
		issuesCards: true,
		logoUrl:
			"https://juupotamdjqzpxuqdtco.supabase.co/storage/v1/object/public/ingenit/banks/tarjeta_cencosud.png",
	},
	{
		code: "SODIMAC",
		name: "Sodimac",
...
export function findBankByCodeOrName(q?: string) {
	...
	return BANK_CATALOG.find(
		(b) => b.code.toLowerCase() === v || b.name.toLowerCase() === v,
	);
}
