...
export const countries: Country[] = [
	{
		...
		regions: [
			...
			},
			{
				code: "CAT",
				name: "Catamarca",
				cities: ["San Fernando del Valle de Catamarca", "Andalgalá", "Belén"],
			},
			{
				code: "CHA",
				name: "Chaco",
				cities: ["Resistencia", "Barranqueras", "Sáenz Peña"],
			},
			{
				code: "CHU",
				name: "Chubut",
				cities: ["Rawson", "Comodoro Rivadavia", "Puerto Madryn", "Trelew"],
			},
			{
				code: "COR",
				name: "Córdoba",
				cities: ["Córdoba", "Río Cuarto", "Villa Carlos Paz", "San Francisco"],
			},
			{
				code: "COR",
				name: "Corrientes",
				cities: ["Corrientes", "Goya", "Mercedes"],
			},
			{
				code: "ER",
				name: "Entre Ríos",
				cities: ["Paraná", "Concordia", "Gualeguaychú"],
			},
			{
				code: "FOR",
				name: "Formosa",
			...
			},
			{
				code: "JUJ",
				name: "Jujuy",
				cities: ["San Salvador de Jujuy", "Palpalá", "Perico"],
			},
			{
				code: "LP",
				name: "La Pampa",
			...
			},
			{
				code: "LR",
				name: "La Rioja",
				cities: ["La Rioja", "Chilecito", "Aimogasta"],
			},
			{
				code: "MEN",
				name: "Mendoza",
				cities: ["Mendoza", "San Rafael", "Godoy Cruz", "Guaymallén"],
			},
			{
				code: "MIS",
				name: "Misiones",
				cities: ["Posadas", "Oberá", "Eldorado"],
			},
			{
				code: "NEU",
				name: "Neuquén",
				cities: ["Neuquén", "Cipolletti", "Plottier"],
			},
			{
				code: "RN",
				name: "Río Negro",
				cities: ["Viedma", "San Carlos de Bariloche", "General Roca"],
			},
			{
				code: "SAL",
				name: "Salta",
				cities: ["Salta", "San Ramón de la Nueva Orán", "Tartagal"],
			},
			{
				code: "SJ",
				name: "San Juan",
				cities: ["San Juan", "Rawson", "Chimbas"],
			},
			{
				code: "SL",
				name: "San Luis",
			...
			},
			{
				code: "SC",
				name: "Santa Cruz",
				cities: ["Río Gallegos", "Caleta Olivia", "El Calafate"],
			},
			{
				code: "SF",
				name: "Santa Fe",
				cities: ["Santa Fe", "Rosario", "Rafaela", "Reconquista"],
			},
			{
				code: "SDE",
				name: "Santiago del Estero",
				cities: ["Santiago del Estero", "La Banda", "Termas de Río Hondo"],
			},
			{
				code: "TF",
			...
			},
			{
				code: "TUC",
				name: "Tucumán",
				cities: ["San Miguel de Tucumán", "Yerba Buena", "Banda del Río Salí"],
			},
		],
	},
	{
		...
		regions: [
			...
			},
			{
				code: "OR",
				name: "Oruro",
				cities: ["Oruro", "Challapata", "Llallagua"],
			},
			{ code: "PT", name: "Potosí", cities: ["Potosí", "Uyuni", "Tupiza"] },
			{
				code: "TJ",
				name: "Tarija",
				cities: ["Tarija", "Yacuiba", "Villamontes"],
			},
			{
				code: "SC",
				name: "Santa Cruz",
			...
			},
			{
				code: "BE",
				name: "Beni",
				cities: ["Trinidad", "Riberalta", "Guayamerín"],
			},
			{
				code: "PA",
				name: "Pando",
				cities: ["Cobija", "Porvenir", "Filadelfia"],
			},
		],
	},
	{
		...
		regions: [
			...
			},
			{
				code: "AL",
				name: "Alagoas",
				cities: ["Maceió", "Arapiraca", "Palmeira dos Índios"],
			},
			{
				code: "AP",
				name: "Amapá",
	...
	},
	{
		...
		regions: [
			...
			{ code: "BOY", name: "Boyacá", cities: ["Tunja", "Duitama", "Sogamoso"] },
			{
				code: "CAL",
				name: "Caldas",
				cities: ["Manizales", "Villamaría", "La Dorada"],
			},
			{
				code: "CAQ",
				name: "Caquetá",
			...
			{ code: "CHO", name: "Chocó", cities: ["Quibdó", "Istmina", "Condoto"] },
			{
				code: "COR",
				name: "Córdoba",
				cities: ["Montería", "Lorica", "Cereté"],
			},
			{
				code: "CUN",
				name: "Cundinamarca",
				cities: ["Soacha", "Girardot", "Zipaquirá", "Facatativá"],
			},
			...
			},
			{
				code: "QUI",
				name: "Quindío",
				cities: ["Armenia", "Calarcá", "La Tebaida"],
			},
			{
				code: "RIS",
				name: "Risaralda",
			...
			},
			{
				code: "SUC",
				name: "Sucre",
				cities: ["Sincelejo", "Corozal", "Sampués"],
			},
			{ code: "TOL", name: "Tolima", cities: ["Ibagué", "Espinal", "Melgar"] },
			{
				code: "VAC",
				name: "Valle del Cauca",
				cities: ["Cali", "Palmira", "Buenaventura", "Cartago"],
			},
	...
	},
	{
		...
		regions: [
			...
			},
			{
				code: "CAN",
				name: "Cañar",
				cities: ["Azogues", "La Troncal", "Cañar"],
			},
			{
				code: "CAR",
				name: "Carchi",
				cities: ["Tulcán", "San Gabriel", "Montúfar"],
			},
			{
				code: "CHI",
				name: "Chimborazo",
				cities: ["Riobamba", "Alausí", "Guano"],
			},
			{
				code: "COT",
				name: "Cotopaxi",
				cities: ["Latacunga", "La Maná", "Salcedo"],
			},
			{
				code: "EOR",
				name: "El Oro",
			...
			},
			{
				code: "ESM",
				name: "Esmeraldas",
				cities: ["Esmeraldas", "Atacames", "Muisne"],
			},
			{
				code: "GAL",
				name: "Galápagos",
				cities: ["Puerto Baquerizo Moreno", "Puerto Ayora"],
			},
			{
				code: "GUA",
				name: "Guayas",
				cities: ["Guayaquil", "Durán", "Milagro"],
			},
			{
				code: "IMB",
				name: "Imbabura",
			...
			},
			{
				code: "SUC",
				name: "Sucumbíos",
				cities: ["Nueva Loja", "Gonzalo Pizarro", "Putumayo"],
			},
			{
				code: "TUN",
				name: "Tungurahua",
				cities: ["Ambato", "Baños", "Pelileo"],
			},
			{
				code: "ZCH",
				name: "Zamora Chinchipe",
				cities: ["Zamora", "Yantzaza", "Gualaquiza"],
			},
		],
	},
	{
		...
		regions: [
			{ code: "CAY", name: "Cayena", cities: ["Cayena", "Remire-Montjoly"] },
			{
				...
				cities: ["Saint-Laurent-du-Maroni", "Mana"],
			},
		],
	},
	{
		...
		regions: [
			{
				code: "BA",
				name: "Barima-Waini",
				cities: ["Mabaruma", "Port Kaituma"],
			},
			{ code: "CU", name: "Cuyuni-Mazaruni", cities: ["Bartica", "Mahdia"] },
			{
				code: "DE",
				name: "Demerara-Mahaica",
				cities: ["Georgetown", "Triumph"],
			},
			{
				code: "EB",
				name: "East Berbice-Corentyne",
				cities: ["New Amsterdam", "Corriverton"],
			},
			{
				code: "ES",
				name: "Essequibo Islands-West Demerara",
				cities: ["Vreed en Hoop", "Parika"],
			},
			{
				code: "MA",
				name: "Mahaica-Berbice",
				cities: ["Fort Wellington", "Mahaicony"],
			},
			{
				code: "PM",
				name: "Pomeroon-Supenaam",
				cities: ["Anna Regina", "Charity"],
			},
			{
				code: "PT",
				name: "Potaro-Siparuni",
				cities: ["Mahdia", "Paramakatoi"],
			},
			{
				code: "UD",
				name: "Upper Demerara-Berbice",
				cities: ["Linden", "Kwakwani"],
			},
			{
				code: "UT",
				name: "Upper Takutu-Upper Essequibo",
				cities: ["Lethem", "Good Hope"],
			},
		],
	},
	{
		...
		regions: [
			{ code: "ASU", name: "Asunción", cities: ["Asunción"] },
			{
				code: "CON",
				name: "Concepción",
				cities: ["Concepción", "Horqueta", "Loreto"],
			},
			{
				code: "SPE",
				name: "San Pedro",
				cities: ["San Pedro", "Capiibary", "San Estanislao"],
			},
			{
				code: "COR",
				name: "Cordillera",
				cities: ["Caacupé", "Tobatí", "Atyrá"],
			},
			{
				code: "GUA",
				name: "Guairá",
				cities: ["Villarrica", "Coronel Oviedo", "Caazapá"],
			},
			{
				code: "CAA",
				name: "Caaguazú",
				cities: ["Coronel Oviedo", "Caaguazú", "Repatriación"],
			},
			{
				code: "CAZ",
				name: "Caazapá",
				cities: ["Caazapá", "San Juan Nepomuceno"],
			},
			{
				code: "ITA",
				name: "Itapúa",
				cities: ["Encarnación", "Capitán Miranda", "María Auxiliadora"],
			},
			{
				code: "MIS",
				name: "Misiones",
				cities: ["San Juan Bautista", "Ayolas", "San Ignacio"],
			},
			{
				code: "PAR",
				name: "Paraguarí",
				cities: ["Paraguarí", "Piribebuy", "Carapeguá"],
			},
			{
				code: "AHA",
				name: "Alto Paraná",
			...
			},
			{
				code: "CEN",
				name: "Central",
				cities: ["Lambaré", "San Lorenzo", "Capiatá", "Luque"],
			},
			{
				code: "ÑEE",
				name: "Ñeembucú",
				cities: ["Pilar", "Villalbín", "Guazu Cuá"],
			},
			{
				code: "AMB",
				name: "Amambay",
				cities: ["Pedro Juan Caballero", "Bella Vista Norte"],
			},
			{
				code: "CAN",
				name: "Canindeyú",
				cities: ["Salto del Guairá", "Curuguaty"],
			},
			{
				code: "PHA",
				name: "Presidente Hayes",
				cities: ["Villa Hayes", "Pozo Colorado"],
			},
			{ code: "BOQ", name: "Boquerón", cities: ["Filadelfia", "Loma Plata"] },
			{
				code: "AAP",
				name: "Alto Paraguay",
				cities: ["Fuerte Olimpo", "Puerto Casado"],
			},
		],
	},
	{
		...
		regions: [
			{
				code: "LMA",
				name: "Lima",
				cities: ["Lima", "Callao", "San Juan de Lurigancho"],
			},
			{
				code: "ARE",
				name: "Arequipa",
				cities: ["Arequipa", "Mollendo", "Camaná"],
			},
			{
				code: "TRU",
				name: "La Libertad",
				cities: ["Trujillo", "Chepén", "Pacasmayo"],
			},
			{ code: "PIU", name: "Piura", cities: ["Piura", "Sullana", "Talara"] },
			{
				code: "LAM",
				name: "Lambayeque",
				cities: ["Chiclayo", "Lambayeque", "Ferreñafe"],
			},
			{ code: "ANC", name: "Ancash", cities: ["Huaraz", "Chimbote", "Casma"] },
			{
				code: "CAJ",
				name: "Cajamarca",
				cities: ["Cajamarca", "Jaén", "Chota"],
			},
			{
				code: "LOR",
				name: "Loreto",
				cities: ["Iquitos", "Yurimaguas", "Nauta"],
			},
			{
				code: "UCY",
				name: "Ucayali",
				cities: ["Pucallpa", "Aguaytía", "Contamana"],
			},
			...
			{ code: "ICA", name: "Ica", cities: ["Ica", "Chincha Alta", "Pisco"] },
			{
				code: "HUV",
				name: "Huancavelica",
				cities: ["Huancavelica", "Paucará", "Acobambilla"],
			},
			{
				code: "AYA",
				name: "Ayacucho",
				cities: ["Ayacucho", "Huanta", "San José de Ticllas"],
			},
			{
				code: "APU",
				name: "Apurímac",
				cities: ["Abancay", "Andahuaylas", "Antabamba"],
			},
			{
				code: "CUS",
				name: "Cusco",
				cities: ["Cusco", "Sicuani", "Quillabamba"],
			},
			{
				code: "HUC",
				name: "Huánuco",
				cities: ["Huánuco", "Tingo María", "Ambo"],
			},
			{
				code: "PAS",
				name: "Pasco",
				cities: ["Cerro de Pasco", "Oxapampa", "La Merced"],
			},
			{
				code: "SMA",
				name: "San Martín",
				cities: ["Moyobamba", "Tarapoto", "Juanjuí"],
			},
			{
				code: "AMA",
				name: "Amazonas",
			...
			},
			{
				code: "TUM",
				name: "Tumbes",
				cities: ["Tumbes", "Zarumilla", "Contralmirante Villar"],
			},
			...
			{ code: "PUN", name: "Puno", cities: ["Puno", "Juliaca", "Ilave"] },
			{
				code: "MDR",
				name: "Madre de Dios",
				cities: ["Puerto Maldonado", "Iñapari", "Laberinto"],
			},
		],
	},
	{
		...
		regions: [
			{ code: "BR", name: "Brokopondo", cities: ["Brokopondo", "Brownsweg"] },
			{
				code: "CM",
				name: "Commewijne",
				cities: ["Nieuw Amsterdam", "Tamanredjo"],
			},
	...
	},
	{
		...
		regions: [
			...
			},
			{
				code: "CA",
				name: "Canelones",
				cities: ["Canelones", "Las Piedras", "Pando"],
			},
			{
				code: "CL",
				name: "Cerro Largo",
			...
			},
			{
				code: "CO",
				name: "Colonia",
				cities: ["Colonia del Sacramento", "Juan Lacaze", "Rosario"],
			},
			{
				code: "DU",
				name: "Durazno",
			...
			},
			{
				code: "FD",
				name: "Florida",
				cities: ["Florida", "Sarandí Grande", "Fray Marcos"],
			},
			{
				code: "LA",
				name: "Lavalleja",
			...
			},
			{
				code: "MA",
				name: "Maldonado",
				cities: ["Maldonado", "Punta del Este", "San Carlos"],
			},
			...
			},
			{
				code: "TT",
				name: "Treinta y Tres",
				cities: ["Treinta y Tres", "Vergara", "Santa Clara de Olimar"],
			},
		],
	},
	{
		...
		regions: [
			{ code: "DC", name: "Distrito Capital", cities: ["Caracas"] },
			{
				code: "AM",
				name: "Amazonas",
				cities: ["Puerto Ayacucho", "La Esmeralda"],
			},
			{
				code: "AN",
				name: "Anzoátegui",
				cities: ["Barcelona", "Puerto La Cruz", "El Tigre"],
			},
			{
				code: "AP",
				name: "Apure",
				cities: ["San Fernando de Apure", "Achaguas"],
			},
			{
				code: "AR",
				name: "Aragua",
				cities: ["Maracay", "Turmero", "La Victoria"],
			},
			{
				code: "BA",
				name: "Barinas",
				cities: ["Barinas", "Barinitas", "Santa Bárbara"],
			},
			{
				code: "BO",
				name: "Bolívar",
				cities: ["Ciudad Bolívar", "Puerto Ordaz", "Upata"],
			},
			{
				code: "CA",
				name: "Carabobo",
				cities: ["Valencia", "Puerto Cabello", "San Diego"],
			},
			{
				code: "CO",
				name: "Cojedes",
				cities: ["San Carlos", "Tinaquillo", "El Pao"],
			},
			{ code: "DA", name: "Delta Amacuro", cities: ["Tucupita", "Pedernales"] },
			{
				code: "FA",
				name: "Falcón",
				cities: ["Coro", "Punto Fijo", "Santa Ana de Coro"],
			},
			{
				code: "GU",
				name: "Guárico",
			...
			},
			{
				code: "LA",
				name: "Lara",
				cities: ["Barquisimeto", "Cabudare", "El Tocuyo"],
			},
			{ code: "ME", name: "Mérida", cities: ["Mérida", "El Vigía", "Tovar"] },
			{
				code: "MI",
				name: "Miranda",
				cities: ["Los Teques", "Guarenas", "Guatire"],
			},
			{
				code: "MO",
				name: "Monagas",
				cities: ["Maturín", "Temblador", "Punta de Mata"],
			},
			{
				code: "NE",
				name: "Nueva Esparta",
				cities: ["La Asunción", "Porlamar", "Juan Griego"],
			},
			{
				code: "PO",
				name: "Portuguesa",
			...
			{ code: "SU", name: "Sucre", cities: ["Cumaná", "Carúpano", "Güiria"] },
			{
				code: "TA",
				name: "Táchira",
				cities: ["San Cristóbal", "Táriba", "Rubio"],
			},
			{
				code: "TR",
				name: "Trujillo",
			...
			},
			{
				code: "VA",
				name: "Vargas",
				cities: ["La Guaira", "Catia La Mar", "Macuto"],
			},
			{
				code: "YA",
				name: "Yaracuy",
			...
			},
			{
				code: "ZU",
				name: "Zulia",
				cities: ["Maracaibo", "San Francisco", "Cabimas"],
			},
		],
	},
];
